...
mongoose.connect("mongodb+srv://greatstackdev:pawar123@cluster0.vtceg8c.mongodb.net/e-commerce");
...
const Product = mongoose.model("Product", {
    ...
    name: {
        type: String, // Added data type for 'name' field
        required: true,
    },
    image: {
        type: String,
    ...
    available: { // Corrected typo in field name
        type: Boolean,
        default: true,
    },
});
